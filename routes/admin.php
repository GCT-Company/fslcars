...
use App\Http\Controllers\Admin\Cars\CarPriceController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::controller(CarPriceController::class)->prefix('price')->name('price.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('store', 'store')->name('store');
        Route::POST('updateAll', 'updateAll')->name('updateAll');
