...
class CarController extends Controller
{
    public function index()
    {
        ...
        $carsWithBookingStatus = Car::join('car_bookings', 'cars.id', '=', 'car_bookings.car_id')
            ->select('cars.id', 'cars.car_area_id', 'cars.car_type_id', 'cars.slug', 'cars.car_model', 'cars.car_number', 'cars.seat','cars.image', 'cars.status', DB::raw('MAX(car_bookings.status) as booking_status'))
            ->groupBy('cars.id', 'cars.car_area_id', 'cars.car_type_id', 'cars.slug', 'cars.car_model', 'cars.car_number', 'cars.seat','cars.image', 'cars.status')
            ->get();
