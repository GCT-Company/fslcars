                    ...
                    <form action="{{ setRoute('user.register.submit') }}" method="POST" class="account-form">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 form-group">
                                <input type="text" class="form-control form--control" name="firstname" id="firstname" placeholder="{{ __("First Name") }}" required>
                            </div>
                            <div class="col-lg-6 col-md-6 form-group">
                            ...
                            <div class="col-lg-12  form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input class="phone-code" type="hidden" name="mobile_code" value="" />
                                                    <input type="text" class="form--control" placeholder="{{ __("Write Here") }}..." name="mobile" value="">
                                                </div>
                                                @error("mobile")
...
@push('script')
    <script>
        ...
        function generateUsername() {
            ...
            if (firstname) {
                var username = firstname + getRandomInt(1000, 9999);
