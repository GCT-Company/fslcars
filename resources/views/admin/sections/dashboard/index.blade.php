            ...
            <div class="row">
                ...
                <div class="col-xxxl-4 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                <h6 class="title">{{ __("Active Car Types") }}</h6>
                                <div class="user-info">
                ...
                <div class="col-xxxl-4 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                <h6 class="title">{{ __("Banned Car Types") }}</h6>
                                <div class="user-info">
                ...
                <div class="col-xxxl-4 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                <h6 class="title">{{ __("Active Cars") }}</h6>
                                <div class="user-info">
                                    <h2 class="user-count">{{ @$activeCars }}</h2>
                                </div>
                                <div class="user-badge">
                                    <span class="badge badge--success">{{ __("Total") }} {{ @$cars }}</span>
                                </div>
                            </div>
                            <div class="right">
                                <div class="chart" id="chart28" data-percent="{{ ($cars != 0) ? intval(($activeCars/$cars)*100) : '0' }}">
                                    <span>
                                        @if ($cars != 0)
                                            {{ intval(($activeCars / $cars) * 100) }}%
                                        @else
                ...
                <div class="col-xxxl-4 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                <h6 class="title">{{ __("Banned Cars") }}</h6>
                                <div class="user-info">
                                    <h2 class="user-count">{{ @$bannedCars }}</h2>
                                </div>
                                <div class="user-badge">
                                    <span class="badge badge--success">{{ __("Total") }} {{ @$cars }}</span>
                                </div>
                            ...
                            <div class="right">
                                <div class="chart" id="chart29" data-percent="{{ ($bannedCars != 0) ? intval(($bannedCars/$cars)*100) : '0' }}">
                                    <span>
                                        @if($bannedCars != 0)
                                            {{ intval(($bannedCars/$cars)*100) }}%
                                        @else
                                            0%
                                        @endif
                                    </span>
